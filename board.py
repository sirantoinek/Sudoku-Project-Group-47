...
class Board:
    def __init__(self, width, height, screen, difficulty):
        ...
        empty_cells = 30 + 10 * difficulty  # 30 for easy, 40 for medium, 50 for hard
    ...
    def check_board(self):
        ...
        if not self.is_full():
            return NO_END  # If board is incomplete, return NO_END
        ...
        for row in range(self.height):  # Checking all rows
            ...
            temp_set.sort()
            if temp_set != valid_set:
                return END_LOSE  # If the sorted row is not equal to the given valid list, the solution is incorrect.
        ...
        for col in range(self.width):  # Checking all columns
            ...
            temp_set.sort()
            if temp_set != valid_set:
                return END_LOSE  # If the sorted column is not equal to the given valid list, the solution is incorrect.
        ...
        for row in range(0, self.height, 3):  # Checking all boxes
            for col in range(0, self.width, 3):
                ...
                temp_set.sort()
                if temp_set != valid_set:
                    return END_LOSE  # If the sorted box is not equal to the given valid list, the solution is incorrect.

        return END_WIN  # END_WIN is returned if the board was solved correctly.
